...
<li><a href="<?php echo get_admin_url(); ?>themes.php?page=theme_options">テーマの管理</a>
	...
	<li><a href="<?php echo get_admin_url(); ?>themes.php?page=custom-header">トップページの大バナー画像</a></li>
	<li><a href="<?php echo get_admin_url(); ?>options-reading.php">トップページの大バナーの下に表示するページの設定</a></li>
	<li><a href="<?php echo get_admin_url(); ?>themes.php?page=theme_options">テーマオプション</a>
		...
		<li><a href="<?php echo get_admin_url(); ?>themes.php?page=theme_options#postSetting">「お知らせ」と「<?php echo bizVektorOptions('postLabelName') ?>」の設定</a></li>
		...
		<li><a href="<?php echo get_admin_url(); ?>themes.php?page=theme_options#galaSetting">携帯（ガラケー）の設定</a></li>
		</ul>
	</li>
...
<li><a href="<?php echo get_admin_url(); ?>edit.php?post_type=info">お知らせの管理</a>
	<ul>
	<li><a href="<?php echo get_admin_url(); ?>edit.php?post_type=info">お知らせ一覧</a></li>
	<li><a href="<?php echo get_admin_url(); ?>post-new.php?post_type=info">お知らせの投稿</a></li>
	<?php // 編集者以上
	if (7 <= $user_level) { ?>
	<li><a href="<?php echo get_admin_url(); ?>edit-tags.php?taxonomy=info-cat">お知らせのカテゴリー</a></li>
	<?php } ?>
	</ul>
</li>
<?php // 編集者以上
